...
### 🛋️ [Furnish Frenzy](https://github.com/Pedro-Chaidez/Furnish-Frenzy)
*Unity · C# · Git*
...
### 🎵 [Bluetooth Audio Visualizer](https://github.com/DestinysCodePortfolio/Bluetooth-Audio-Visualizer)
...
### 🎹 [Producer Asset Assistant](https://github.com/DestinysCodePortfolio/Producer-Asset-Assistant)
...
### 🎮 [FRAT-NIGHT (Rush Week)](https://github.com/DestinysCodePortfolio/FRAT-NIGHT)
*C++ · CMake · CI/CD*
...
### 🥁 [Rhythm Rage](https://github.com/DestinysCodePortfolio/Rhythm-Rage)
...
### 🎛️ [OMNICHORD](https://github.com/DestinysCodePortfolio/OMNICHORD)
...
**UCR EcoCAR** — CAV HMI Engineer *(July 2025 – June 2026)*
Mapped 20+ CAN signals into a PowerVision PV1200 HMI display using DBC-style bit-level configuration. Built signal simulation workflows to validate behavior without live hardware.

**Highlander Combat Robotics** — Co-Founder & VP *(May 2023 – Oct 2025)*
Led integration across mechanical, electrical, and firmware teams. Secured $5,000+ in funding through written proposals. Ran structured debugging and test planning across build cycles.
